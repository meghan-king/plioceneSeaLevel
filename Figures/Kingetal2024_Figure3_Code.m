...
%% Greenland
data = fopen('.../IceModels/Greenland/ice316'); %131,346,316
M2Greenland = fread(data, 'float32');
data = fopen('.../IceModels/Greenland/ice456'); %131,346,316
...
%% NorthAmerica
data = fopen('.../IceModels/NorthAmerica/ice316'); %131,346,316
M2NorthAmerica = fread(data, 'float32');
data = fopen('.../IceModels/NorthAmerica/ice456'); %131,346,316
...
%% PrydzBay
data = fopen('.../IceModels/PrydzBay/ice316'); %131,346,316
M2PrydzBay = fread(data, 'float32');
data = fopen('.../IceModels/PrydzBay/ice456'); %131,346,316
...
%% WestAntarctica
data = fopen('.../IceModels/WestAntarctica/ice316'); %131,346,316
M2WestAntarctica = fread(data, 'float32');
data = fopen('.../IceModels/WestAntarctica/ice456'); %131,346,316
...
%% WilkesBasin
data = fopen('.../IceModels/WilkesBasin/ice316'); %131,346,316
M2WilkesBasin = fread(data, 'float32');
data = fopen('.../IceModels/WilkesBasin/ice456'); %131,346,316
