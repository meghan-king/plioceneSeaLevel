%% Figure 2 
%Code to plot Figure 2 in King et al., 2024. 
...
%Figure 1a
subplot(2,1,1)
plot(Time,d18O,'color','k','LineWidth',1)
xlim([2900 3650])
ylim([2.8 3.8])
...
ylabel('\delta^1^8O (?)','FontSize',16)

%Figure 1b
subplot(2,1,2)
plot(Time,Scalar_factor_initial,'color','k','LineWidth',1)
xlim([2900 3650])
ylim([-0.1 1.2])
a = get(gca,'XTickLabel');
set(gca,'XTickLabel',a,'fontsize',12)
...
set(gca,'XDir','reverse')
xlabel('Time (ka)','FontSize',16)
ylabel('Normalized Stack','FontSize',16)